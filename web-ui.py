...
STYLES = {
    "List": {
        "style": "Return your response as python code.",
...
LANGUAGES = ["Default", "English", "Japanese", "Chinese",
             "Spanish", "Korean", "Russian", "French", "German", ]
...
Please generate code of the following text delimited by tripple backquotes.
{style}
...
map_prompt_template = """
Write a concise code of the following text:
{text}

CONCISE CODE {in_language}:
"""
